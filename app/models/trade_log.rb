class TradeLog < ActiveRecord::Base
  attr_accessible :basicPrice, :basicPriceForeign, :buyValueForeign, :buyValueJPY, :date, :dividendValueForeign, :dividendValueJPY, :noItem, :sellValueForeign, :sellValueJPY, :type, :memo
